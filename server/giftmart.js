...
var labEnv = process.env.NODE_ENV= process.env.NODE_ENV || 'development';

var connectionString = ""; 

if(labEnv === 'development'){
    connectionString = 'mongodb://localhost:27017/gift';
    console.log('Connection String is '+connectionString);
}else{
    connectionString = 'mongodb://admin:admin@ds023408.mlab.com:23408/giftcart';
}
//var db = MongoClient.connect('mongodb://localhost:27017/giftcart');
...
//(function (db) {
            ...
            items.getItems(category, page, ITEMS_PER_PAGE, function(pageItems) {
                ...
                items.getNumItems(category, function(itemCount) {
                    ...
                    /*res.render('home', { category_param: category,
                                         ...
                                         page: page,
                                         items: pageItems });*/
                    res.json({data:{category_param: category,
                                         categories: categories,
                                         useRangeBasedPagination: false,
                                         itemCount: itemCount,
                                         pages: numPages,
    ...
    router.get("/item/id/:itemId", function(req, res) {
        "use strict";

        var itemId = parseInt(req.params.itemId);
        console.log('item id passed is '+itemId);
    ...
    var server = app.listen(process.env.PORT || 3000, function() {
        ...
        console.log('Giftmart server listening on port %s.', port);
    });
